...
export const DEMO_PRESETS: readonly DemoPreset[] = [
  {
    ...
    expectation: "Expected: booking-claim passes because the claim matches a successful tool event; policy-compliance passes.",
    case: {
...
export const DEMO_RUBRICS: readonly Rubric[] = [
  ...
  parseRubric({
    ...
    kind: "claim-support",
    severity: "major",
    description: "Factual claims are supported by the supplied reference material.",
    criterion: "Is each specific factual claim in the response stated or directly entailed by the reference material?",
  }),
  parseRubric({
...
export const DEMO_FIXTURES: FixtureFile = {
  ...
  cases: {
    "demo-booking-success": {
      ...
      "claim-support": { probabilities: { supported: 0.62, contradicted: 0.05, not_covered: 0.33 } },
    ...
    "demo-booking-failed-tool": {
      ...
      "claim-support": { probabilities: { supported: 0.6, contradicted: 0.05, not_covered: 0.35 } },
    ...
    "demo-claim-missing-reference": {
      ...
      "claim-support": { probabilities: { supported: 0.04, contradicted: 0.06, not_covered: 0.9 } },
