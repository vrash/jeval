  ...
  return (
    <>
      ...
      <div className="prose">
        ...
        <p>
          The bundled example datasets and their expected labels were written for this repository and have not been independently reviewed; they
          exercise the framework. The public-benchmark runs use each dataset&apos;s own labels: RAGTruth&apos;s are human, HaluEval&apos;s are
          model-generated and filtered, τ-bench has none per check.
        </p>
        ...
        <ul>
          <li>Judging quality on your data. The recorded RAGTruth run (300 human-labelled responses) is one dataset, one rubric wording and one day; HaluEval labels are model-generated; τ-bench trajectories have no per-check labels.</li>
